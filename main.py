...
if conf.get('CSI', 'enable') == "y":
    ...
    if auto_mipi_csi_test.test_result == "y":
        ...
        fail_results.append(auto_mipi_csi_test.test_result_info + "\t" + auto_mipi_csi_test.note_information + "\n")
        # log_file_all.write(auto_mipi_csi_test.test_result_info)
...
if conf.get('UVC', 'enable') == "y":
    ...
    if auto_uvc_test.test_result == "y":
        ...
        fail_results.append(auto_uvc_test.test_result_info + "\t" + auto_uvc_test.note_information + "\n")
        # log_file_all.write(auto_uvc_test.test_result_info)
...
if conf.get('DSI', 'enable') == "y":
    ...
    if auto_mipi_dsi_test.test_result == "y":
        ...
        fail_results.append(auto_mipi_dsi_test.test_result_info + "\t" + auto_mipi_dsi_test.note_information + "\n")
    time.sleep(2)
else:
...
if conf.get('PWMDAC', 'enable') == "y":
    ...
    if auto_pwmdac_test.test_result == "y":
        ...
        fail_results.append(auto_pwmdac_test.test_result_info + "\t" + auto_pwmdac_test.note_information + "\n")
    time.sleep(2)
else:
...
if conf.get('HDMI', 'enable') == "y":
    ...
    if auto_hdmi_test.test_result == "y":
        ...
        fail_results(auto_hdmi_test.test_result_info + "\t" + auto_hdmi_test.note_information + "\n")
    time.sleep(2)
else:
...
if conf.get('SD', 'enable') == "y":
    ...
    if auto_sd_test.is_pass:
        ...
        pass_results.append(auto_sd_test.rmsg + "\t" + auto_sd_test.wmsg + "\n")
    else:
        fail_results.append(auto_sd_test.rmsg + "\t" + auto_sd_test.wmsg + "\n")
    time.sleep(2)
else:
...
if conf.get('PCIE_SSD', 'enable') == "y":
    ...
    if auto_pcie_ssd_test.is_pass == "y":
        ...
        pass_results.append(auto_pcie_ssd_test.rmsg + "\t" + auto_pcie_ssd_test.wmsg + "\n")
    else:
        fail_results.append(auto_pcie_ssd_test.rmsg + "\t" + auto_pcie_ssd_test.wmsg + "\n")
    time.sleep(2)
else:
...
if conf.get('EMMC', 'enable') == "y":
    ...
    if auto_emmc_test.is_pass == "y":
        ...
        pass_results.append(auto_emmc_test.rmsg + "\t" + auto_emmc_test.wmsg + "\n")
    else:
        fail_results.append(auto_emmc_test.rmsg + "\t" + auto_emmc_test.wmsg + "\n")
    time.sleep(2)
else:
...
if conf.get('USB', 'enable') == "y":
    ...
    num = 0
    while num <= 3:
        for i in auto_usb_test.is_pass:
            if i == "y":
                pass_results.append(auto_usb_test.rinfo[num] + "\t" + auto_usb_test.winfo[num])
                num+=1
                continue
            elif i == "n":
                fail_results.append(auto_usb_test.rinfo[num] + "\t" + auto_usb_test.winfo[num])
                num+=1
                continue
            else:
...
if conf.get('GPIO', 'enable') == "y":
    ...
    if auto_gpio_test.is_pass == "y":
        ...
        fail_results.append(auto_gpio_test.result_info + "\n")
...
if conf.get('TEMPERATURE', 'enable') == "y":
    ...
    if auto_temperature_test.is_pass == "y":
        ...
        fail_results.append(auto_temperature_test.temp_msg + "\n")
    time.sleep(2)
else:
...
if conf.get('GMAC0', 'enable') == "y":
    ...
    if auto_gmac0_test.is_pass == "y":
        ...
        pass_results.append(auto_gmac0_test.tx_results + "\t" + auto_gmac0_test.rx_results + "\n")
    else:
        fail_results.append(auto_gmac0_test.tx_results + "\t" + auto_gmac0_test.rx_results + "\n")
    time.sleep(2)
else:
...
if conf.get('GMAC1', 'enable') == "y":
    ...
    if auto_gmac1_test.is_pass == "y":
        ...
        pass_results.append(auto_gmac1_test.tx_results + "\t" + auto_gmac1_test.rx_results + "\n")
    else:
